...
// node_modules/@axieinfinity/mixer/dist/index.js
var require_dist = __commonJS({
  "node_modules/@axieinfinity/mixer/dist/index.js"(exports) {
    ...
    var BoneMatrix = class _BoneMatrix {
      ...
      static CalculateSetupWorld(boneData) {
        if (boneData === null) {
          return new _BoneMatrix(null);
        }
        if (boneData.parent === null) {
          return _BoneMatrix.GetInheritedInternal(boneData, new _BoneMatrix(null));
        }
        const result = _BoneMatrix.CalculateSetupWorld(boneData.parent);
        return _BoneMatrix.GetInheritedInternal(boneData, result);
      }
      static GetInheritedInternal(boneData, parentMatrix) {
        const parent = boneData.parent;
        if (parent === null) {
          return new _BoneMatrix(boneData);
        }
        const pa = parentMatrix.a, pb = parentMatrix.b, pc = parentMatrix.c, pd = parentMatrix.d;
        const result = new _BoneMatrix(null);
    ...
    var exportAvatarLayers = (skeletonJson, adultCombo, variantKey, partColorShift, getVariantAttachmentPath2, customize) => {
      const boneMap = {};
      ...
      for (const slotName in skinAttachments) {
        ...
        let selectedSlotName = slotName in skinSlotAttachments ? slotName : null;
        ...
        for (const attachmentName in skinSlotAttachments) {
          ...
          const tx = bm.x;
          const ty = bm.y;
          toRenderSlots[slotName] = { attachmentPath: path, x: rootX + tx * scale - w / 2, y: rootY - ty * scale - h / 2 };
          break;
        }
      }
      const layers = [];
      for (let i = 0; i < skeletonJson.slots.length; i++) {
        ...
        if (slot.name in toRenderSlots) {
          ...
          const imagePath = getVariantAttachmentPath2(slot.name, attachmentPath, variantKey, partColorShift);
    ...
    (function(CharacterClass) {
      CharacterClass["Aquatic"] = "Aquatic";
      CharacterClass["Beast"] = "Beast";
      CharacterClass["Bird"] = "Bird";
      CharacterClass["Bug"] = "Bug";
      CharacterClass["Dawn"] = "Dawn";
      CharacterClass["Dusk"] = "Dusk";
      CharacterClass["Mech"] = "Mech";
      CharacterClass["Plant"] = "Plant";
      CharacterClass["Reptile"] = "Reptile";
      CharacterClass["Any"] = "Any";
    })(exports.CharacterClass || (exports.CharacterClass = {}));
    exports.AxieClassValue = void 0;
    (function(AxieClassValue) {
      AxieClassValue[AxieClassValue["Beast"] = 0] = "Beast";
      AxieClassValue[AxieClassValue["Bug"] = 1] = "Bug";
      AxieClassValue[AxieClassValue["Bird"] = 2] = "Bird";
      AxieClassValue[AxieClassValue["Plant"] = 3] = "Plant";
      AxieClassValue[AxieClassValue["Aquatic"] = 4] = "Aquatic";
      AxieClassValue[AxieClassValue["Reptile"] = 5] = "Reptile";
      AxieClassValue[AxieClassValue["Mech"] = 16] = "Mech";
      AxieClassValue[AxieClassValue["Dawn"] = 17] = "Dawn";
      AxieClassValue[AxieClassValue["Dusk"] = 18] = "Dusk";
    })(exports.AxieClassValue || (exports.AxieClassValue = {}));
    exports.BodyShape = void 0;
    (function(BodyShape) {
      BodyShape["BigYak"] = "BigYak";
      BodyShape["Curly"] = "Curly";
      BodyShape["Frosty"] = "Frosty";
      BodyShape["Fuzzy"] = "Fuzzy";
      BodyShape["Normal"] = "Normal";
      BodyShape["Spiky"] = "Spiky";
      BodyShape["Sumo"] = "Sumo";
      BodyShape["Wavy"] = "Wavy";
      BodyShape["WetDog"] = "WetDog";
      BodyShape["Nightmare"] = "Nightmare";
    })(exports.BodyShape || (exports.BodyShape = {}));
    exports.AxiePartType = void 0;
    (function(AxiePartType) {
      AxiePartType["Eyes"] = "Eyes";
      AxiePartType["Mouth"] = "Mouth";
      AxiePartType["Ears"] = "Ears";
      AxiePartType["Horn"] = "Horn";
      AxiePartType["Back"] = "Back";
      AxiePartType["Tail"] = "Tail";
    })(exports.AxiePartType || (exports.AxiePartType = {}));
    var axiePartTypes = [exports.AxiePartType.Eyes, exports.AxiePartType.Mouth, exports.AxiePartType.Ears, exports.AxiePartType.Horn, exports.AxiePartType.Back, exports.AxiePartType.Tail];
    var characterClasses = [exports.CharacterClass.Beast, exports.CharacterClass.Bug, exports.CharacterClass.Bird, exports.CharacterClass.Plant, exports.CharacterClass.Aquatic, exports.CharacterClass.Reptile, exports.CharacterClass.Mech, exports.CharacterClass.Dawn, exports.CharacterClass.Dusk];
    exports.BoneComboType = void 0;
    (function(BoneComboType) {
      BoneComboType["body"] = "body";
      BoneComboType["back"] = "back";
      BoneComboType["ear"] = "ear";
      BoneComboType["eyes"] = "eyes";
      BoneComboType["horn"] = "horn";
      BoneComboType["tail"] = "tail";
      BoneComboType["mouth"] = "mouth";
    })(exports.BoneComboType || (exports.BoneComboType = {}));
    var boneComboTypes = [exports.BoneComboType.body, exports.BoneComboType.back, exports.BoneComboType.ear, exports.BoneComboType.eyes, exports.BoneComboType.horn, exports.BoneComboType.tail, exports.BoneComboType.mouth];
    function getCharacterClassFromValue(value) {
      switch (value) {
        case exports.AxieClassValue.Beast:
          return exports.CharacterClass.Beast;
        case exports.AxieClassValue.Bug:
          return exports.CharacterClass.Bug;
        case exports.AxieClassValue.Bird:
          return exports.CharacterClass.Bird;
        case exports.AxieClassValue.Plant:
          return exports.CharacterClass.Plant;
        case exports.AxieClassValue.Aquatic:
          return exports.CharacterClass.Aquatic;
        case exports.AxieClassValue.Reptile:
          return exports.CharacterClass.Reptile;
        case exports.AxieClassValue.Mech:
          return exports.CharacterClass.Mech;
        case exports.AxieClassValue.Dawn:
          return exports.CharacterClass.Dawn;
        case exports.AxieClassValue.Dusk:
          return exports.CharacterClass.Dusk;
      }
      return exports.CharacterClass.Any;
    }
    var ACESSORY_SLOTS = ["body-air", "body-cheek", "body-ground", "body-hip", "body-neck"];
    ...
    var BigNumber = bn.exports;
    var bitsFromLeft = (value, totalBits) => {
      const extractor = (bits) => {
    ...
    var getAxieBodyStructure512 = (geneString) => {
      ...
      const bodyStructure = { class: getCharacterClassFromValue(mainClass), body: [bodyDetail0, bodyDetail1, bodyDetail2], bodySkin, primaryColors: [primaryColor0, primaryColor1, primaryColor2], secondaryColors: [secondaryColor0, secondaryColor1, secondaryColor2], parts: {} };
      for (let partIndex = 0; partIndex < 6; partIndex++) {
        ...
        const part = { stageCap: 2, stage: partStage, reservation: partReservation, skinInheritability: partSkinInheritability === 0 ? false : true, skin: partSkin, groups: [] };
        part.groups.push({ class: getCharacterClassFromValue(partClass0), value: partValue0 });
        part.groups.push({ class: getCharacterClassFromValue(partClass1), value: partValue1 });
        part.groups.push({ class: getCharacterClassFromValue(partClass2), value: partValue2 });
    ...
    var AxieGenesStuff = class {
      ...
      load(genesJson) {
        ...
        for (const genesBody of genesBodies) {
          const bodySample = { skin: genesBody["skin"], bodyValue: genesBody["bodyValue"], mysticValue: genesBody["mysticValue"], bodyName: genesBody["bodyName"] };
      ...
      findPart(partClass, partType, partValue) {
      ...
      findPartBySample(partType, sampleName) {
        const partIndex = this.partSamples.findIndex(function(x) {
          return x.partType === partType && (x.skins.indexOf(sampleName) != -1 || x.skinsLv2.indexOf(sampleName) != -1);
        });
        if (partIndex === -1) {
          return null;
        }
      ...
      overridePartSample(partType, sampleName, stage, skin) {
        if (stage == -1 && skin == -1) {
          return sampleName;
        }
      ...
      getPartSample(partType, part) {
        return this.getPartSampleCustom(partType, part, part.stage, part.skin);
      }
      getPartSampleCustom(partType, part, stage, skin) {
      ...
      getAdultCombo(bodyStructure) {
        ...
        const axieCombo = /* @__PURE__ */ new Map();
        ...
        axieCombo.set("back", this.getPartSample(exports.AxiePartType.Back, bodyStructure.parts[exports.AxiePartType.Back]));
        axieCombo.set("ears", this.getPartSample(exports.AxiePartType.Ears, bodyStructure.parts[exports.AxiePartType.Ears]));
        axieCombo.set("ear", axieCombo.get("ears"));
        axieCombo.set("eyes", this.getPartSample(exports.AxiePartType.Eyes, bodyStructure.parts[exports.AxiePartType.Eyes]));
        axieCombo.set("horn", this.getPartSample(exports.AxiePartType.Horn, bodyStructure.parts[exports.AxiePartType.Horn]));
        axieCombo.set("mouth", this.getPartSample(exports.AxiePartType.Mouth, bodyStructure.parts[exports.AxiePartType.Mouth]));
        axieCombo.set("tail", this.getPartSample(exports.AxiePartType.Tail, bodyStructure.parts[exports.AxiePartType.Tail]));
        return axieCombo;
      }
      getAxieColorsVariant(primaryValue, bodySkin, bodyClass) {
        let variantIndex = -1;
        for (let i = 0; i < this.axieSkinColors.length; i++) {
          ...
          if ((axieSkin.class === exports.CharacterClass.Any || axieSkin.class.toLowerCase() === bodyClass.toLowerCase()) && (axieSkin.colorValue === -1 || axieSkin.colorValue === primaryValue)) {
            variantIndex = i;
            break;
          }
        }
      ...
      getAxieVariantKeyFromIndex(variantIndex) {
    ...
    var MixedSkeletonData = class {
      constructor(bones, slots, skins, ik, events, animations) {
    ...
    var getSampleName = (name, boneCombo) => {
    ...
    var addCustomBoneRule = (edges, sortingRules) => {
    ...
    var mixEntriesFromSample = (mapEntries, boneCombo, samples, sortingRules) => {
      const edges = {};
      ...
      for (let i = 1; i < boneComboTypes.length; i++) {
        ...
        const bodyNodes2 = mapEntries(samples.get(boneCombo[i]));
        previousName = bodyNodes2[0]["name"];
        for (let index = 1; index < bodyNodes2.length; index++) {
          const entry = bodyNodes2[index];
          const entryName = entry["name"];
          if (!isBodySample(entryName)) {
      ...
      function visit(name, visited2, edges2, sortedNames2) {
        if (!visited2[name]) {
          visited2[name] = true;
          if (edges2[name]) {
            for (const edge of edges2[name]) {
              visit(edge, visited2, edges2, sortedNames2);
            }
          }
          sortedNames2.push(name);
        }
      }
      const visited = {};
      const sortedNames = [];
    ...
    var mixSkins = (boneCombo, samples, boneNames, skinNames, slotNames, debug = false) => {
      const skins = [];
      const slotTransform = (slot, sampleName) => {
      ...
      const getSlotInSampleSkins = (skinName, slotName, sampleName) => {
        const sample = samples.get(sampleName);
        const skin = sample.skins.find((skin2) => skin2["name"] === skinName);
        if (skin) {
          const skinAttachments = skin.attachments;
          if (skinAttachments === void 0) {
            return void 0;
          }
    ...
    var mix = (boneCombo, samples, sortingRules, debug = false) => {
    ...
    var AxieMierStuff = class {
      ...
      generateAsset(adultCombo, skipAnim, debug = false) {
        const boneCombo = [];
        ...
        for (const slotName in skins[0].attachments) {
        ...
        if (skipAnim) {
          ...
          for (const animationHeader of this.animationHeaders) {
            ...
            if (animationHeader.name == "action/idle/normal" || animationHeader.name == "action/idle/random-01" || animationHeader.name == "action/idle/random-02" || animationHeader.name == "action/idle/random-03" || animationHeader.name == "action/idle/random-04") {
              ...
              if (crcKey in this.animationCRCMap) {
                ...
                if (sampleAnimation.drawOrder) {
                  for (const drawOrderMap in sampleAnimation.drawOrder) {
                    const clone = { time: drawOrderMap["time"], offsets: [] };
                      ...
                      for (const offsetMap of offsets) {
                        ...
                        if (slotIndex != -1 && bodySlotIndex != -1) {
                          if (slotIndex < bodySlotIndex) {
                            const cloneOffsetData = { slot: offsetMap.slot, offset: bodySlotIndex - slotIndex };
            ...
            const mixedAnimation = { slots: mixedSlots, bones: mixedBones };
    ...
    var mixerStuff = new AxieMierStuff();
    var AxieBuilderResult = class {
      // eslint-disable-next-line @typescript-eslint/no-empty-function
      constructor() {
      }
    };
    function initAxieMixer(GenesData, SamplesData, VariantsData, AnimationsData) {
      genesStuff.load(GenesData);
      mixerStuff.load(SamplesData, VariantsData, AnimationsData);
    }
    var getAxieSpineFromGenes = (gene, meta, skipAnimation = false) => {
      ...
      const variantIdx = genesStuff.getAxieColorsVariant(bodyStructure.primaryColors[0], bodyStructure.bodySkin, bodyStructure.class);
      return getAxieSpineFromCombo(combo, variantIdx, skipAnimation);
    };
    function isNumeric(value) {
      return /^-?\d+$/.test(value);
    }
    function overridePartSample(partType, combo) {
    ...
    var getAxieSpineFromCombo = (combo, colorVariant, skipAnimation = false) => {
      ...
      if (!mixerStuff.initilized) {
        ...
        try {
          ...
          if (combo.has(bodySkinKey) && isNumeric(combo.get(bodySkinKey))) {
            ...
            if (bodySkin != 0) {
              colorVariant = genesStuff.getAxieColorsVariant(0, bodySkin, combo.get("body-class"));
            }
          }
          combo.set("back", overridePartSample(exports.AxiePartType.Back, combo));
          combo.set("ears", overridePartSample(exports.AxiePartType.Ears, combo));
          combo.set("ear", combo.get("ears"));
          combo.set("eyes", overridePartSample(exports.AxiePartType.Eyes, combo));
          combo.set("horn", overridePartSample(exports.AxiePartType.Horn, combo));
          combo.set("mouth", overridePartSample(exports.AxiePartType.Mouth, combo));
          combo.set("tail", overridePartSample(exports.AxiePartType.Tail, combo));
    ...
    var getVariantAttachmentPath = (slotName, attachmentPath, variantKey, partColorShift) => {
    ...
    var getAxieColorPartShift = (variant) => {
...
buffer/index.js:
   ...
   *)
*/
//# sourceMappingURL=@axieinfinity_mixer.js.map
